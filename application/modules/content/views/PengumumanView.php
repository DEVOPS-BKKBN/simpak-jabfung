                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <form action="<?php echo base_url(); ?>content/pengumuman" method="GET">
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="display table table-striped table-hover dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT a.*,b.format_nomor_pendaftaran,DATE_FORMAT(tanggal_pengumuman,'%d-%m-%Y') tgl FROM pengumuman a JOIN pansel b ON a.id_pansel=b.id WHERE a.deleted_at IS NULL $sql2 ORDER BY tanggal_pengumuman DESC";
                                                ...
                                                foreach ($cn->result() as $rw) {
                                                    ...
                                                    echo '<td>' . $rw->judul. '</td>';
                                                    echo '<td><a href="'.base_url().'content/modal?action=viewdok&jenis=pengumuman&hid='.$rw->id.'" class="ls-modal">'. $rw->file.'</a></td>';
                                                    echo '<td><a href="'.base_url().'content/modal?action=viewdok&jenis=lampiran&hid='.$rw->id.'" class="ls-modal">'. $rw->lampiran.'</a></td>';
        ...
        $("#datatable").on("click", ".del", function(e) {
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>content/hapusPengumuman",
