                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <form action="<?php echo base_url(); ?>content/faq" method="GET">
                                    <div class="row">
                                    ...
                                    <div class="col-md-6 group">
                                        <div class="form-group">
                                            ...
                                            <?php
                                                ...
                                                echo $this->ReferensiModel->LoadListMaster($sql,'fltkategori',$this->input->get('fltkategori'),'class="form-control" onchange="this.form.submit()"');
                                            ?>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="table-responsive">
                                        <table id="datatable" class="display table table-striped table-hover dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                if ($this->input->get('fltkategori')!='') $sql2=" AND a.kategori='".$this->input->get('fltkategori')."'";
                                                $sql = "SELECT a.*,b.format_nomor_pendaftaran,DATE_FORMAT(a.created_at,'%d-%m-%Y') tgl FROM faq a JOIN pansel b ON a.id_pansel=b.id WHERE a.deleted_at IS NULL $sql2 ORDER BY a.created_at DESC";
        ...
        $("#datatable").on("click", ".del", function(e) {
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>content/hapusFaq",
