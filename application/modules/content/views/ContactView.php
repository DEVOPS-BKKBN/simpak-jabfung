                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <form action="<?php echo base_url(); ?>content/contact" method="GET">
                                    <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="display table table-striped table-hover dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT a.*,b.format_nomor_pendaftaran,DATE_FORMAT(a.created_at,'%d-%m-%Y') tgl,u.nama 
                                                        FROM contact a JOIN pansel b ON a.id_pansel=b.id 
                                                        JOIN users u ON a.id_user=u.id
                                                        WHERE a.deleted_at IS NULL $sql2 ORDER BY a.created_at DESC";
